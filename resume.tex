...
\tagline{Hola! Me llamo Agustín. Tengo 18 años y soy técnico en computación.\\
...
%    Section are set in bold face. An optional parameter of \texttt{\textbackslash section} takes a symbol to add in front of the text. This option is used in the jobs and education sections below.
    ...
    \job{¿2022 - ...?}
        ...
        \par{Pendiente para anotarme en Febrero.}
    ...
    \wheelchart{1.2cm}{0.5cm}{
        ...
        7/8em/accent!80/Aprendiendo cosas nuevas,
        6/8em/accent!40/Posible espacio para trabajo,
        5/8em/accent!60/Ocio.
    }
}
\makebody
